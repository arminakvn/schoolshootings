...
(function() {
  var createSlider, dataLoaded, drawGraph, drawTimeSeries, eventData, graph, height, height2, line, map, map_el, margin, margin2, parseDate, path, projection, scales, svg, svgLine, usTopoJson, width, xAxis, xAxis2, yAxis;
  ...
  createSlider = function(eventData) {
    var brush, brushed, handle, hendleSlides, slider;
